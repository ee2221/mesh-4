...
import { Cuboid, Cherry, Cylinder, Cone, Pyramid, Move, RotateCw, Maximize, Sun, Edit3, Projector as Vector, Box, Grid as GridIcon, Link as Line, PenTool } from 'lucide-react';
